...
"""
This script is used to do warmups steps on the learning rate during training. Inspired by:
`"Attention Is All You Need" <https://arxiv.org/pdf/1606.08415v3.pdf>`_.

Usage: type "from learning_rate_warmup import <class>" to use one of its classes.
...
class NoamOpt():
    ...
    """
    Warmup method inspired by `<http://nlp.seas.harvard.edu/2018/04/03/attention.html>`_.
    """
